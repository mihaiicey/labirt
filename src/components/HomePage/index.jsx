...
export default function Home() {
  ...
  return (
    <>
      <section style={{ backgroundImage: `url(${heroImg})` }} className="relative bg-no-repeat	bg-cover bg-center">
        <div className="mx-auto max-w-screen-xl px-4 py-28 lg:flex lg:h-[90vh] lg:items-center relative">
          <div className="mx-auto max-w-xl text-center">
            <h1 className="text-xl font-bold sm:text-4xl text-white">
              <strong className="font-bold text-red-600  sm:block">Ti-e foame sau pofta de o bere?</strong>
