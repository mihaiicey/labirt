      ...
      <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0=">
        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 md:space-y-6">
            ...
            <button type="submit" className="w-full text-white bg-secondary hover:bg-gray-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
              Logare
            </button>
            <p className="text-sm font-light text-gray-500">Nu ai cont?<a className="ml-1 font-medium text-secondary hover:underline" href="/register">Inregistreaza-te</a></p>
          </form>
        </div>
      </div>
    </div>
